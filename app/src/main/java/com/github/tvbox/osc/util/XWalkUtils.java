...
public class XWalkUtils {
    ...
    public static String downUrl() {
        ...
        //return String.format("https://o0halflife0o.github.io/crosswalk/releases/crosswalk/android/stable/23.53.589.4/%s/crosswalk-apks-23.53.589.4-%s.zip", getRuntimeAbi(), getRuntimeAbi());
        return String.format("https://gh-proxy.com/https://raw.githubusercontent.com/o0HalfLife0o/crosswalk/master/releases/crosswalk/android/stable/23.53.589.4/%s/crosswalk-apks-23.53.589.4-%s.zip", getRuntimeAbi(), getRuntimeAbi());
    }
